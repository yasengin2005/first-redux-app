...
const Counter = () => {
  ...
  const counter = useSelector((state) => state.counter); // useSelector is a hook that allows us to access the state or tiny parts of data from the store and automatically make subscriptions components to store.
